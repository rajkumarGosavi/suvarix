...
const holdings = computed(() => portfolio.equity.map((h: any) => ({
    ...h,
...
function confirmDelete(item: any) {
    confirm.require({
        message: `Remove ${item.name} (${item.symbol}) from portfolio?`,
...
<template>
    <div class="panel">
        ...
        <DataTable :value="holdings" stripedRows emptyMessage="No equity holdings. Click Add to get started.">
